...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_LayoutFcn',  @Health_Info_Practical_3_LayoutFcn, ...
                   'gui_Callback',   []);
...
function h1 = Health_Info_Practical_3_LayoutFcn(policy)
...
appdata.GUIDEOptions = struct(...
    ...
    'syscolorfig', 1, ...
    'blocking', 0, ...
    'lastSavedFile', '/home/silent/documents/class/bmed8813/practicals/Health Info Practical 3/Health_Info_Practical_3.m', ...
    'lastFilename', '/home/silent/documents/class/bmed8813/practicals/Health Info Practical 3/Health_Info_Practical_3.fig');
...
'Callback',@(hObject,eventdata)Health_Info_Practical_3('start_time_Callback',hObject,eventdata,guidata(hObject)),...
'FontSize',10.6666666666667,...
'Position',[29.6666666666667 8.23076923076923 20.1666666666667 1.69230769230769],...
'String',blanks(0),...
'Style','edit',...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)Health_Info_Practical_3('start_time_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'Tag','start_time');
...
'FontUnits','pixels',...
'BackgroundColor',[1 1 1],...
'Callback',@(hObject,eventdata)Health_Info_Practical_3('end_time_Callback',hObject,eventdata,guidata(hObject)),...
'FontSize',10.6666666666667,...
'Position',[29.6666666666667 4.38461538461539 20.1666666666667 1.69230769230769],...
'String',blanks(0),...
'Style','edit',...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)Health_Info_Practical_3('end_time_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'Tag','end_time');
...
'FontUnits','pixels',...
'BackgroundColor',[1 1 1],...
'Callback',@(hObject,eventdata)Health_Info_Practical_3('hr_Callback',hObject,eventdata,guidata(hObject)),...
'FontSize',10.6666666666667,...
'Position',[29.6666666666667 0.538461538461539 20.1666666666667 1.69230769230769],...
'String',blanks(0),...
'Style','edit',...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)Health_Info_Practical_3('hr_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'Tag','hr');
...
'FontUnits','pixels',...
'BackgroundColor',[1 1 1],...
'Callback',@(hObject,eventdata)Health_Info_Practical_3('avg_rr_interval_Callback',hObject,eventdata,guidata(hObject)),...
'FontSize',10.6666666666667,...
'Position',[74.8333333333333 8.23076923076923 20.1666666666667 1.69230769230769],...
'String',blanks(0),...
'Style','edit',...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)Health_Info_Practical_3('avg_rr_interval_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'Tag','avg_rr_interval');
...
'Units','characters',...
'FontUnits','pixels',...
'Callback',@(hObject,eventdata)Health_Info_Practical_3('quit_Callback',hObject,eventdata,guidata(hObject)),...
'FontSize',10.6666666666667,...
...
'Units','characters',...
'FontUnits','pixels',...
'Callback',@(hObject,eventdata)Health_Info_Practical_3('save_Callback',hObject,eventdata,guidata(hObject)),...
'FontSize',10.6666666666667,...
...
'FontUnits','pixels',...
'BackgroundColor',[1 1 1],...
'Callback',@(hObject,eventdata)Health_Info_Practical_3('waveform_Callback',hObject,eventdata,guidata(hObject)),...
'FontSize',10.6666666666667,...
'Position',[3.4 0.692307692307692 30.4 7.69230769230769],...
'String',{  'mitdb/100'; 'mitdb/101'; 'mitdb/102'; 'mitdb/103'; 'mitdb/104'; 'mitdb/105'; 'mitdb/106'; 'mitdb/107'; 'mitdb/108'; 'mitdb/109' },...
'Style','listbox',...
'Value',1,...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)Health_Info_Practical_3('waveform_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'Tag','waveform');
...
'FontUnits','pixels',...
'BackgroundColor',[1 1 1],...
'Callback',@(hObject,eventdata)Health_Info_Practical_3('avg_qr_Callback',hObject,eventdata,guidata(hObject)),...
'FontSize',10.6666666666667,...
'Position',[74.8333333333333 4.38461538461539 20.1666666666667 1.69230769230769],...
'String',blanks(0),...
'Style','edit',...
'CreateFcn', {@local_CreateFcn, @(hObject,eventdata)Health_Info_Practical_3('avg_qr_CreateFcn',hObject,eventdata,guidata(hObject)), appdata} ,...
'Tag','avg_qr');
...
if numargin == 0
    % Health_Info_Practical_3
    % create the GUI only if we are not in the process of loading it
    % already
    gui_Create = true;
elseif local_isInvokeActiveXCallback(gui_State, varargin{:})
    % Health_Info_Practical_3(ACTIVEX,...)
...
elseif local_isInvokeHGCallback(gui_State, varargin{:})
    % Health_Info_Practical_3('CALLBACK',hObject,eventData,handles,...)
    gui_Create = false;
else
    % Health_Info_Practical_3(...)
